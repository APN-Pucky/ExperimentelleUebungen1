...
\begin{document}
	...
	\section{Kurzfassung}
	Um die Elastizität verschiedener Materialien zu untersuchen, wurden zwei Experimente durchgeführt. Zunächst wurden die Auslenkungen von Stäben unter Last gemessen und daraus deren Elastizitätmodul bestimmt. Dieser ließ Schlüsse auf die Art der Materialien zu. Dann wurde mithilfe verschiedener angehängter Objekte ein Torsionspendel untersucht und so der Schubmodul des Torsionsdrahtes bestimmt. 
	...
	blub%TODO Materialien vergleich mit Literatur, Abweichungen auf exakte Gewichte schieben
	\\
	\par
