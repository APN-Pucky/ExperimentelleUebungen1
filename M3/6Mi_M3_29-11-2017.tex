	...
	*** Unsicherheitenrechnung \\
	...
	\begin{table}[H]
		...
		\begin{tabular}{ r | c | c | c | c | c |} 
			...
			$ \bar{x} $  & $\SI{0,0,24848}{cm}$ &  $\SI{0,54966}{cm}$ &  $\SI{0,29313}{cm}$ &  $\SI{0,2976}{cm}$ & $\SI{0,2974}{cm}$  \\ \hline
		\end{tabular}
	...
	\begin{table}[H]
		...
		%TODO
		\end{tabular}
		\caption{Mittelwerte $ \bar{x} $, die sich aus den Messwerten für die Abmessungen der Scheibe, Hantel und Hantelscheiben ergeben}
