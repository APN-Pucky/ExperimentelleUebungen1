...
\begin{document}
	...
	*** Schreiben welcher STab warum welches Material vermutlich ist. ERSTE BEOBACHTUNG \\
	...
	\subsubsection{Bestimmung der benötigten Größen und deren Unsicherheiten} %TODO Struktur,Texteinbindung, Tabellen-floating
	...
	\end{itemize}
	Einsetzten ergibt ein $G$ von $\SI{7,8587\pm 0,3706e10}{Nm^{-2}}$. Dabei folgte die Unsicherheit wieder aus \cref{Partielle_Unsicherheiten}.
