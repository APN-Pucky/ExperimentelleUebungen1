...
\begin{document}
	...
	*** Unsicherheitenrechnung \\
	...
	\begin{figure}[H]
		...
		\centering
		\caption{Torsion eines Drahtes mit verschiedene Hanteln}
		\label{TorsionGraph}
		\centering
	\end{figure}
	...
	\begin{table}[H]
		\centering
		\begin{tabular}{ r | c | c | c | c | c |} %TODO Breite fixen
