...
\begin{document}
	...
	\begin{tabular}{ l | c | c | c |}
		...
		Aus der Kopplungsformel   &$\SI{0,2171}{}$&$\SI{0,3779}{}$\\  \hline
		Aus der Kopplungsnäherung   &$\SI{0,2165}{}$&$\SI{0,3729}{}$\\  \hline
	\end{tabular}
	\caption{relative Frequenzaufspaltungen}
	\end{table}
	...
	Abfallen der Ampilutde mit der Zeit.
