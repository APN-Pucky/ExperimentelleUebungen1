...
\begin{document}
	...
	\end{equation}
	Beim Einsetzten aller Größen ergibt sich ein Trägheitsmoment von $J = \SI{42.550 \pm 0,1875}{kg cm^2}$ mit einer relativen Abweichung von 0,441\%. Die Unsicherheit wurde mittels \cref{Partielle_Unsicherheiten} bestimmt. %TODO Texte Über Unsicherheiten bzw. Anhang or not cause unnessassary
