...
\begin{document}
	...
	In den Graphen \cref{Praez1}, \cref{Praez2} und \cref{Praez3} sind jeweils die Präzessionszeiten $T_p$ gegen die Frequenz $\omega$ des Kreisels aufgetragen. Die rote Funktion ist ein linearer Fit, jedoch betrachtet der Algorithmus lediglich die Messpunkte und nicht die Fehlerintervalle, deshalb ist es nicht praktisch die angegebenen Unsicherheiten weiter zu verwenden. 
	...
	Als mögliche Fehlerquellen, die nicht in Zahlenwerte gefasst werden konnten, sind hier die mögliche Verformung des Fallrades durch Herunterfallen bei vorherigen Benutzern sowie die Tatsache zu nennen.
