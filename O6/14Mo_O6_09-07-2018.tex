...
\begin{document}
	...
	%TODO Einzellinse: Umrechnungsfaktor + Kehrwert auflösung gibt Halbwertsbreite
...
Die Unsicherheiten werden gemäß GUM ermittelt. 
	...
	\begin{description}
		...
		\item[Kamera:] Die Unsicherheiten von verschiedenen Angaben auf der Kamera werden als verschwindend gering angenohmen.
			Dazu zählen die Messung durch den CMOS-Sensor, die Brennweite des Nikkor-Objektivs, die eingestellte Belichtungszeit und die Durchmesser der Blendenöffnungen. %TODO mehr?
	\end{description} 
