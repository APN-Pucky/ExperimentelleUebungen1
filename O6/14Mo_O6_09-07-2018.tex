...
Die Unsicherheiten werden gemäß GUM ermittelt. 
	...
	\subsubsection{Schärfentiefe des Nikkor-Objektivs}
	...
	\subsubsection{Auflösung des Nikkor-Objektivs}
	...
	\begin{figure}[H]  
		...
		\centering
		\caption{
			MTF-Kurven der untersuchte Blendenzahlen $k$, die durch das ImageJ-Plugin "Praktikum Slanted Edge MTF" berechnet wurde.
