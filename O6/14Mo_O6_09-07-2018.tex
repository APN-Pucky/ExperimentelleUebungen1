...
\begin{document}
	...
	\begin{description}
		...
		\item[Subjektive Schärfe:] Inwiefern ein Fehler für die Angabe eines subjektiven Werts sinnvoll ist, ist fraglich.
			Dennoch wird hier eine Unsicherheit von \SI{1}{cm} auf der schrägen Skala angenommen, um sicherzugehen, dass immer möglichst gleich scharfe Bereiche gewählt werden. %TODO dadurch geht man doch nicht sicher?
	...
	\begin{equation}
		...
		\label{eq_fernpunkt}
	\end{equation}
	wobei $d_h$ die hyperfokale Entfernung ist: %TODO theoretisch fehlt hier ein komma
	\begin{equation}
	...
	\begin{figure}[H]  
		...
		\caption{
			...
			Dies entspricht dem Fall $g\approx d_h$, sodass $d_f$ divergiert. %TODO muss das hier auch weg?
			}
	...
	\subsubsection{Diskussion}
	Offensichtlich wird zunächst, dass die Auflösung mit dem Blendendurchmesser steigt, während die Halbwertsfrequenz mit dem Blendendurchmesser sinkt. %TODO sollte man das noch irgendwie erklären?
