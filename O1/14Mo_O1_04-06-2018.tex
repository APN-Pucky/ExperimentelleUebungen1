...
\begin{document}
	...
	\end{equation}
	Im Falle eines eintrefenden kollimerten Strahls der nach dem Linsensystem erneut kollimiert ist liegt der Fokus im Unendlichen.
	...
	Es ergibts sich also eine Brennweite von \SI{3,2+-1,7}{cm} für die Streulinse.
