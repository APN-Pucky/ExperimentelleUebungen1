...
\begin{document}
	...
	\begin{description}
		...
		\item[Hall-Sonde:]  Die Stärke des Magnetfelds wird mit einer Hall-Sonde gemessen. Die Messwerte schwanken in der fünften Nachkommastelle, sodass eine Unsicherheit von \SI{30}{\mu T} angenommen wird. %TODO 0.0001/2sqrt(6) != 0.03
	...
	Die Stärke des Magnetfelds an der Position der Probe wird mit der Hall-Sonde in einem Winkel $\theta$ gemessen. %doppelt, obwohl du diesmal die Methoden schon lesen konntest. Einzig relevant ist, dass das theta heißt, deswegen lass ich'S drin =\SI{45}{\degree}
	Für ein $\theta=\SI{90}{\degree}$ wurde $\vec B_\text{Mess} = \SI{0,1}{mT}$ gemessen. %TODO hab das bissl umstrukturiert, weil die Aussage "es wird bei theta=45 gemessen. Bei theta=90 ergab sich blub" komisch ist. ich hoffe, ich hab hier keine Änderung von Dir verschluckt, aber da war halt nichts anders glaub ich
	...
	Des Weiteren wurde beobachtet, dass die Messwerte der Photodiode um ca. $\SI{\pm0,2}{}$ schwanken, wenn man an den Tisch stößt. %TODO fine?
