...
\begin{document}
	...
	Außerdem könnte man, anstatt den Analysator konstant auf \SI{45}{\degree} einzustellen und das Gesetz von Malus als linear zu nähern, mit dem Analysator für jeden Messwert eine komplette Messkurve der Intensität in Abhängigkeit vom Analysatorwinkel aufnehmen und so bei der Bestimmung der Magnetisierung eine angenäherte Proportionalität weniger haben, da in diesem Fall die Polarisationsänderung gemäß dem Gesetz von Malus direkt gemessen werden würde. % hmm "Das Messsignal ist die
