...
\begin{document}
	...
	\end{equation}
	und das Verhältnis b/g lässt sich bestimmen indem man $ \text{sinc}(\pi x)$ graphisch gleich dem Verhältnis $I_1/I_0$ setzt (unter der einschränkenden Voraussetzung $b/g<1$, da $\text{sinc}(x)$ sonst nicht umkehrbar ist).
