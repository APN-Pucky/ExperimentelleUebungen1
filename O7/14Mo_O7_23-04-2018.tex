...
\begin{document}
	...
	\begin{equation}
		...
		\label{einzelminmax}
	\end{equation}
	Der Winkel $\sin(\vartheta)$ ergibt sich nach \cref{dreieck} aus dem Abstand des Gitters zum Schirm bzw. Sensor $d$ = \SI{0,78 +- 0,009}{m} (Dreieckige WDF) und der Position des Extremas $x$. 
	\begin{equation}
