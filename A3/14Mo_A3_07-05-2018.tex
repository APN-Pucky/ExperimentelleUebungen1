...
\begin{document}
	...
	\end{equation}
	 ...
	 Die hier bestimmten $\mu$ wurden bei einer $\gamma$-Strahlung mit einer Energie von ca. \SI{0,66}{MeV} gemessen. %TODO "von ...eV" ist uneindeutig. Meinst du E_max? Wenn ja, schreib das.
