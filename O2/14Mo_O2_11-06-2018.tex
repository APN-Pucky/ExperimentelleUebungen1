...
\begin{document}
	...
	Dabei wird der Halbzylinder einmal so gedreht, dass die Welle erst durch die flache Seite des Halbzylinders und dann die runde fällt und einmal so, dass es andersherum stattfindet.
	
	Dann wird der Halbzylinder so gedreht, dass die Mikrowelle zuerst auf die runde Seite fällt und im Inneren an der flachen Seite Totalreflexion zu beobachten ist. %TODO ist dass zu unpräzise?
	...
	Es wird in vier verschiedenen Abständen zum Sender in orthogonaler Richtung elf mal die Intensität gemessen.
