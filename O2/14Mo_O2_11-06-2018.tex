...
\begin{document}
	...
	\begin{figure}[H]
		\includegraphics[width=1\textwidth]{fig_rund_zyl}
		\centering
	...
	Aus der Steigung $a$ von \SI{0,634+-0,020}{} folgt $n_\text{PVC} = \SI{1,57 +- 0,05}{}$.
	\begin{figure}[H]
		\includegraphics[width=1\textwidth]{fig_flach_zyl}
		\centering
