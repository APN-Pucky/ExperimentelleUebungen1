...
\begin{document}
	...
	Wenn man die realen Leistungszahlen des Stirling-Motors einerseits als Wärmepumpe ($\SI{23,2+-3,0}{\%}$) und andererseits als Kältemaschine (\SI{5,1 +- 0,3}{\%}) vergleicht, stellt man fest, dass ersterer deutlich höher ist.
	...
	Die Angabe eines deutlich geringeren Fehlers wäre allerdings ob der Schwankungen auf der Anzeige des Thermometers nicht zu verantworten gewesen.
