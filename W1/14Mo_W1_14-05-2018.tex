...
\begin{document}
	...
	Es wurde angenommen, dass die Verwendung eines Stirling-Motors eine Methode ist diese Werte zu bestimmten.
	Da die Literaturwerte die Messwerte von Schmelzwärme von Wasser $S$ = \SI{233,7\pm 4,5}{J/g} und spezifischer Wärme von Eis $c_\text{Eis}$ = $\SI{2,254+-0,007}{J/g/K}$ bestätigten, konnte diese Annahme bestätigt werden.%TODO soll ich lit.-Wert erwähnen?
	...
	%TODO Schmelzwärme kleiner weil Umgebung, z.B,. Kondenzwasser, aber ist es ja nicht signifikant...
	
	Der abrupte Sprung in \cref{fig_Kuehl} kommt dadurch zustande, dass das Wasser zunächst auf eine Temperatur unterhalb des Gefrierpunktes abgekühlt werden kann und %TODO
	...
	Der Literaturwert \cite{schmelzWarm} von \SI{334}{J/g} liegt innerhalb der Unsicherheiten dieses Messwerts.
	...
	Insofern kann die Möglichkeit der Verwendung eines Stirling-Motors zur Bestimmung der Schmelzwärme und spezifischen Wärme bestätigt werden.
	...
	Das kann damit zusammenhängen, dass beim Betrieb als Kältemaschine die Wasserprobe, während ihr Energie entzogen wird, Energie aus der Umgebung des Motors aufnehmen kann.
	Dies ließ sich darin beobachten, dass sich Eiskristalle am Zylinder bildeten.
