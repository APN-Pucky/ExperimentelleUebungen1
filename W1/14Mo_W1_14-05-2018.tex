...
\begin{document}
	...
	Die Reibungsverluste lassen sich aus der Erwärmung des Kühlwassers beim Betrieb der Wärmepmpe bzw. Kältemaschine bei offenem Zylinderkopf bestimmen.
	...
	Die Masse $m$ im System ist nicht direkt bestimmbar, der Durchfluss des Kühlwasser $m/t$ hingegen schon.
	Somit lässt sich mit \cref{Wärme} die an das Kühlwasser abgegebenen Leistung $\Delta{Q}/t$ ermitteln.
	Die gesuchte Reibungsarbeit pro Umlauf erhält durch Division der Leistung durch die Frequenz des Motors.
