...
\begin{document}
	...
	\begin{table}[tb]
		...
		\begin{tabular}{ r | c | c | c}
			& Voltmeter & Amperemeter & Leistungsmesser \\ \hline %TODO NAMEN
			 Messunsicherheit& \SI{0,0204}{V}&  \SI{0,004}{A}&  \SI{0,04}{W}\\

		\end{tabular}
		\caption{Unsicherheiten verschiedener Messapparaturen.} %TODO mehr hier
	...
	\begin{table}[tb]
		...
		\end{tabular}
		\caption{Berechneter Innenwiderstand von jeweils einem Akku.} %TODO besser Beschreibung
	...
	Es ist in beiden Fällen eine Steigung von 1 zu erwarten, da $P = UI$ gilt. Im Fall des Wechselstroms wurden nur Effektivwerte gemessen, da dies einen Faktor von $\frac{1}{2}$ für die Leistung und 2 Faktoren von $\sqrt{2}$ für $UI$ bedeutet, bleibt die Steigung dieselbe.
