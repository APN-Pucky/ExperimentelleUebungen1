...
\begin{document}
	...
	Wenn man diese Spannung jedoch an Anode und Kathode misst, ergibt sich ca. $U_B$ = \SI{0}{V}.
 	...
 	%DONE Komplikationen mit MEssgerät => Trioden linie graph => ist Falsch 
	
	%DONE Mann misst auch eine Spannung selbst wenn keine Beschleunigungs spannung angelegt ist
	
			%DONE Temperatur schwankte zwischen 165 und 180
			%DONE Oszi graphen (ggf. nur der eine)
