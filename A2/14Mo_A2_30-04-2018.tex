...
\begin{document}
	...
	\begin{equation}
		...
		\label{Clausius}
	\end{equation}
	Dabei betragen allgemeine Gaskonstante $R$ = $\SI{8,3145}{J/mol/K}$,Verdampfungsenthalpie $\Delta{H_\text{m,v}}$ =  $\SI{59,3}{kJ/mol}$, $r_\text{Hg}$ = $\SI{150}{pm}$ und der Referenzpunkt ist $T_1$ = $\SI{293,15}{K}$ mit $p_1$ = $\SI{0,242}{Pa}$.\cite{Quecksilber}\cite{Enthalpie}\cite{NIST}
	Durch Umformen von \cref{Clausius} ergibt sich $p_\text{kalt}$ = \SI{0,223+-0,028}{Pa} und $p_\text{warm}$ = \SI{1,3+-0,2}{kPa}.
	Daraus widerum folgt mit \cref{frei} $\lambda_\text{kalt}$ = $\SI{0,256+- 0,032}{m}$ und $\lambda_\text{warm}$ = $\SI{0,068 +- 0,010}{mm}$.
