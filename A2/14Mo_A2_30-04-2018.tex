...
\begin{document}
	...
	Die Unsicherheit des  Voltmeters beträgt $\pm (U \cdot 0,5\% + \SI{200}{mV})$ für die Beschleunigungsspannung und $\pm (U \cdot 0,5\% + \SI{20}{mV})$ für die gemessene Spannung (0,5\% vom angezeigten Wert).\cite{FH-Pforzheim} Die Unsicherheit des Operationsverstärker wird als vernachlässigbar gering angenommen. 
	...
	Beim Bestimmen der Beschleunigungsspannung an Extremstellen setzt sich die Unsicherheit aus dem Verlauf der Kurve und dem Abstand zum nächsten Messpunkt zusammen. %TODO FINE?!?
