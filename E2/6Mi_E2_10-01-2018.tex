...
\begin{document}
	...
	\begin{itemize}
		...
		\item Dichte der Luft: $\rho_\text{L}= \SI{1,2929}{\kilogram \per \metre \cubed}$ %TODO Unsicherheit
	\end{itemize}
	...
	Für die Größe der Elementarladung ist der Literaturwert von $ e \approx \SI{1,6 e-19}{\coulomb}$ bekannt. %TODO Reflink
