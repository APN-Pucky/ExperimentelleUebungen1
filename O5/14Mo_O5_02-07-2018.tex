...
\begin{document}
	...
	Eine Natriumdampflampe wird vor den Spalt gebracht und das Prisma auf den Prismentisch in den Strahlengang gestellt. %TODO irgendwas mit symmetrischer Strahlengang oder Apex?
	...
	\begin{description}
		\item[Winkelmessung:] Die Winkel am Spektrometer ließen sich bis auf zwei Nachkommastellen genau analog ablesen. %TODO AUAAAAAAAA, jetzt leider wohl bissl spät zum fixen, aber das hätte ich so auf keinen Fall gemacht. Wir haben die doch später nur auch noch auf eine Stelle genau und die meinte ich natürlich auch mit rechteckkram und die Einstellunsicherheit ist doch größer als dieses Winzige
		...
		Beim Gitter mit $g=1/\SI{600}{mm}$ waren die Maxima nur noch mit einer Unsicherheit von \SI{0,02}{\degree} einem Winkel zuordnen. %das war hab ich halt so gemacht, weil das davor viel zu genau war.
		%TODO da du uns in die Scheiße geritten hast, mach mal nen deutschen Satz draus. Der ist halt nicht war, aber jetzt ist's halt too late.
		...
		Da die Spannung lediglich zum Messen, wann die LED zu leuchten beginnt und dies mit dem Auge nur grob abgeschätzt werden konnte, verwendet wurde, wurde die Unsicherheit mit \SI{0,03}{V} abgeschätzt. %TODO Deutsch pls
	\end{description}
	...
	Auftretende Restlichteffekte ließen sich durch Abschirmung mit beispielsweise den Händen entfernen. %TODO Das ist halt einfach nicht wahr.
	\begin{figure}[H]
		\centering
	...
	Dies ist nicht überraschend, da die Unsicherheit der Wellenlänge bereits größer als die Differenz der Wellenlänge der beiden Linien ist. %TODO ich hoffe das ist wahr mit deinen absurd geringen Fehlern
