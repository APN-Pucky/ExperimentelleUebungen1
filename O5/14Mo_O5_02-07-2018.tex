...
\begin{document}
	...
	\begin{figure}[H] 
		...
		Es wurden lediglich Maxima der ersten Beugungsordnung beobachtet. %TODO ergo y-Achse unnötig. Außerdem sind das zu viele. Einige sind ja keine Spektrallinien, sondern so ausgeschmierter Bereich. Man soll die die diskreten Spektrallinien bestimmen und mit dem kann ich so nichts anfangen.
		}
		\label{fig_spar}
		\centering
	\end{figure}
