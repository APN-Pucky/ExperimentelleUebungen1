...
\begin{document}
	...
	\begin{figure}[H] %TODO Warum haben nur die Schwarzen Fehler und warum ist die y-Achse so lang gestreckt? Die könnte halt auch viel kürzer Sein und die Grafik dann halt auch. Die großen Leerflächen braucht man nicht. Die Symbole könnten größer sein.
	...
	In der Einführung ist eine Tabelle zur Kalibrierung des Spektrometers gegeben. %TODO Soll man die angeben, nach Mühlenstrodt scheinbar ja
	...
	\begin{figure}[H] 
		...
		Es wurden lediglich Maxima der ersten Beugungsordnung beobachtet.} %TODO ergo y-Achse unnötig, warum nicht wie oben mit ticks? Wenn zu aufwändig ok.
		\label{fig_spar}
		\centering
	\end{figure}	
	...
	\subsection{Diskussion} %TODO SPLITTEN!
