...
\begin{document}
	...
	\begin{description}
		\item[Winkelmessung:] Die Winkel am Spektrometer ließen sich bis auf zwei Nachkommastellen genau analog ablesen. %TODO AUAAAAAAAA, jetzt leider wohl bissl spät zum fixen, aber das hätte ich so auf keinen Fall gemacht.
	...
	\begin{figure}[H] 
		...
		Die schwarzen Linien wurden als diskrete Spektrallinien beobachtet und die roten sind die Maxima von ausgeschmiert Spektrallinien. 
		}
		\label{fig_spar}
		\centering
	\end{figure}
	...
	In \cref{fig_quecksilber} ist das Spektrum, das \cite{Quecksilber} angibt, dargestellt. Ein Vergleich mit den Messwerten ergibt dass die Maxima im gelben Bereich gemessen wird, wobei das eine ausgeschmiert ist.
