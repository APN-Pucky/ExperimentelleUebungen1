...
\begin{document}
	...
	\begin{figure}[H]
		...
		\end{tikzpicture}
		\caption{Skizze der sichtbaren Spektrallinien der Natriumdampflampe nach Brechung an einem Prisma.} %TODO irgendwie erwähnen, dass das super qualitativ ist und die Abstände mehr so abgeschätzt, kann ich aber auch denken.
		\label{fig_draw}
	\end{figure}
	...
	\begin{figure}[H] %TODO Warum haben nur die Schwarzen Fehler und warum ist die y-Achse so lang gestreckt? Die könnte halt auch viel kürzer Sein und die Grafik dann halt auch. Die großen Leerflächen braucht man nicht. Die Symbole könnten größer sein. durch die riesigen Abstände werden die Ordnungen auch schlecht zu vergleichen -> irgendwas langes Senkrechtes als Symbol? bei librecalc kann man bild als symbol einfügen-> einfach langer Strich?
	...
	Ein linearer Fit liegt jedoch deutlich genauer an den Messpunkten, weshalb dieser dienlicher als Kalibrationskurve ist.%TODO eigentlich nicht erlaubt, oder?
	Es ist auffällig, dass der Vorfaktor $a$ des Sinus-Fits den erwarteten Wert von 1/\SI{600}{mm} beinhaltet. 
	Aus dem $a$ würde eine Gitterkonstante innerhalb des Bereichs von 1/\SI{577}{mm} bis 1/\SI{613}{mm} folgen. %TODO würde folgen? Warum nicht folgt?
